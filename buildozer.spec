...
# (str) Package name
package.name = ergosanitas

# (str) Package domain (needed for android/ios packaging)
package.domain = cl.ergosanitas
...
requirements = python3,kivy,kivymd,opencv,numpy,pyyaml,pillow,mediapipe,plyer,pyjnius
